...
<hr>
<h3 align="left">Salesforce Tools:</h3>
<hr>
<strong>Data Management :</strong> - Data Loader, Data Import Wizard, Data Export <br><br>
<strong>Data Modelling :</strong> - Custom Objects, Validation Rules, Creating custom fields, Actions, Record Type, Buttons and Links, Schema Builder(a bit) <br><br>
<strong>Data Security :</strong> - Customized Organizations level access like Password policy, Trusted Ip range, Object Level access using Profile and permission sets, Record Level Security using OWD,Role Hierarchy and Sharing rules, Field level access control through <br><br>
<strong>UI Customization :</strong> - Page Layout , App builder, Compact Layout , App, Email Templates  <br><br>
<strong>Analytics :</strong> - Reports, Dashboards<br><br>
<strong> 
<strong>Pro-code Tools :</strong> Apex Programing language(Hands on Trigger,async Apex, apex Integeration through REST API, Apex unit testing) & LWC(TO create the custom components that can be reused again and again.)<br><br>
<strong>Process Automation:</strong> Lightning Flows and Approval Process <br><br>
<strong>Clouds</strong>: Sales Cloud, Service Cloud.
<hr>
...
<a href="https://spring.io/" target="_blank" rel="noreferrer"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain-wordmark.svg"
 height="60" width="80" />
 </a>
